...
This audit records the executable evidence for Foundation 5 without weakening the checkpoint. F5 closes only when the F5.A acceptance bar, the F5.B acceptance bar, and the F5 closure bar are all supported by executable behavior on the exact reviewed head.
...
This document becomes a closed F5 audit only after all of the following are true on the exact pull-request head:
...
Until those conditions are satisfied, this audit is evidence-in-progress rather than a closure claim.
