...
def test_administrator_initializes_migrates_and_bootstraps_fresh_store(tmp_path):
    ...
    assert initialized.schema_revision == "0009_personal_calendar_action_authority"
    ...
    assert migrated.previous_revision == "0009_personal_calendar_action_authority"
    assert migrated.schema_revision == "0009_personal_calendar_action_authority"
