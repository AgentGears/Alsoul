...
def test_administrator_initializes_migrates_and_bootstraps_fresh_store(tmp_path):
    ...
    assert initialized.schema_revision == "0006_personal_calendar_acquisition"
    ...
    assert migrated.previous_revision == "0006_personal_calendar_acquisition"
    assert migrated.schema_revision == "0006_personal_calendar_acquisition"
