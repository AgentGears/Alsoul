...
def test_administrator_initializes_migrates_and_bootstraps_fresh_store(tmp_path):
    ...
    assert initialized.schema_revision == "0012_personal_calendar_create_transport"
    ...
    assert migrated.previous_revision == "0012_personal_calendar_create_transport"
    assert migrated.schema_revision == "0012_personal_calendar_create_transport"
