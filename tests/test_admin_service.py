...
def test_administrator_initializes_migrates_and_bootstraps_fresh_store(tmp_path):
    ...
    assert initialized.schema_revision == "0017_personal_calendar_mutation_presentation"
    ...
    assert migrated.previous_revision == "0017_personal_calendar_mutation_presentation"
    assert migrated.schema_revision == "0017_personal_calendar_mutation_presentation"
