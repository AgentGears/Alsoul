"""Add F5.B calendar-create intent and consent authority.

Revision ID: 0009_personal_calendar_mutation_authority
...
revision = "0009_personal_calendar_mutation_authority"
...
_RECEIPT_SCOPES = (
    "CreatePersonalCalendarAction",
    "GrantCalendarCreatePermission",
    "SetPersonalCalendarWritePolicy",
    "PresentCalendarCreateApproval",
    "GrantCalendarCreateApproval",
    "RevokeCalendarCreatePermission",
    "RevokeCalendarCreateApproval",
)
